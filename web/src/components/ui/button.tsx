    ...
    'disabled:opacity-45 disabled:pointer-events-none active:translate-y-px cursor-pointer',
  {
    variants: {
      variant: {
        ...
        /** 软键条上的大按键：手指点得中 */
        key: 'border border-line bg-fg/8 text-fg font-mono min-w-11 active:bg-accent active:border-transparent active:text-white',
      },
      size: {
        default: 'px-[11px] py-[5px] text-[13px]',
        tiny: 'px-[9px] py-[3px] text-xs',
        icon: 'px-2 py-[5px] min-w-8 text-[13px]',
        key: 'px-3 py-2.5 text-[13px] leading-none',
      },
      on: { true: '', false: '' },
    },
    compoundVariants: [
