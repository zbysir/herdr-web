  ...
  return (
    <div className="absolute inset-0 z-20 grid place-items-center bg-bg p-5">
      <div className="w-full max-w-[420px]">
        <h1 className="mb-1 text-[17px] font-semibold tracking-[.2px]">
        ...
        <p className="mb-4 text-[13px] leading-relaxed text-muted">
          {reauth ? (
            ...
            <>
              ...
              <code className="rounded bg-fg/10 px-1.5 py-px">herdr-web pair</code>
              ，它会打出一个二维码和一个 8 位码。
              <br />
              <span className="text-[12px]">
                {canScan
              ...
              <br />
              <span className="text-[12px]">一台设备配一次，之后这个书签直接进。</span>
            </>
          )}
        </p>
